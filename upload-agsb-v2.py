...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "qazwsxedc123"         # 用户名
UUID = "a217d527-bd5e-4ef0-b899-d36627af0ddd"                     # UUID，留空则自动生成
PORT = 28001                   # Vmess端口，留空或0则自动生成
DOMAIN = "karlo.1976.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNDMxMmY5YTAwNzhjMTI1OTYyZTAwZDY5NzkwMTgxNTMiLCJ0IjoiYzFlOTU3ZDgtMjVlOC00NzZmLTk5MzItODVjODEzZTU0ZDRlIiwicyI6IlptTTNaamhoWkdZdE0yUXdNUzAwTkdRMExUbG1ZMll0TXpZek1qZzRPV1U0T0RjMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
